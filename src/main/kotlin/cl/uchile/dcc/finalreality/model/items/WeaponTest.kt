...
class WeaponTest : FunSpec({
    ...
    matadragones= Sword(SWORD_NAME,
                        SWORD_DAMAGE,
                        SWORD_WEIGHT
    )
    aquaSimulacra= Bow(BOW_NAME,
                       BOW_DAMAGE,
                       BOW_WEIGHT
    )
    kunai= Knife(KNIFE_NAME,
                 KNIFE_DAMAGE,
                 KNIFE_WEIGHT
    )
    bastonDelSello= Staff(STAFF_NAME,
                          STAFF_DAMAGE,
                          STAFF_WEIGHT
    )
    }
    test(
        ...
        val rita2= Axe(AXE_NAME,
                       AXE_DAMAGE,
                       AXE_WEIGHT
        )
        val matadragones2= Sword(SWORD_NAME,
                            SWORD_DAMAGE,
                            SWORD_WEIGHT
        )
        val aquaSimulacra2= Bow(BOW_NAME,
                               BOW_DAMAGE,
                               BOW_WEIGHT
        )
        val kunai2= Knife(KNIFE_NAME,
                         KNIFE_DAMAGE,
                         KNIFE_WEIGHT
        )
        val bastonEstrella= Staff(STAFF_NAME,
                                  STAFF_DAMAGE,
                                  STAFF_WEIGHT
        )
